exports.handler = async (event) => {
  ...
  const statsUrl = `https://query1.finance.yahoo.com/v10/finance/quoteSummary/${ticker}?modules=defaultKeyStatistics,financialData,incomeStatementHistory,cashflowStatementHistory,balanceSheetHistory,summaryProfile`;
  ...
  try {
    ...
    // Parse into clean format for frontend
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        roic: q.financialData?.returnOnAssets?.raw * 100 || null, // Proxy
